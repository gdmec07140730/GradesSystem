...
<div class="am-cf admin-main">
	...
	<div class="am-cf am-padding">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">用户管理</strong> / <small>编辑教师资料</small></div>
	</div>
	<form class="am-form" action="<?php echo U('edit',array('id'=>I('get.id')));?>" method="POST">
		...
		<div class="am-g am-margin-top">
			...
			<div class="am-u-sm-8 am-u-md-4">
				<select data-am-selected="{btnSize: 'sm'}"	 name="class_id">
					<?php if(is_array($classlist)): $i = 0; $__LIST__ = $classlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['id'] == $site['class_id']): ?><option value="<?php echo $vo['id'] ;?>" selected="selected"><?php echo $vo['name'] ;?></option>
						<?php else: ?>
		...
		<div class="am-g am-margin-top">
			...
			<div class="am-u-sm-8 am-u-md-4">
				<select data-am-selected="{btnSize: 'sm'}">
					<?php if($site['role'] == 1): ?><option value="1" selected="selected">教师</option>
					<?php else: ?>
						<option value="0" selected="selected">学生</option><?php endif; ?>
				</select>
			</div>
			<div class="am-hide-sm-only am-u-md-6">*必填</div>
		</div>
