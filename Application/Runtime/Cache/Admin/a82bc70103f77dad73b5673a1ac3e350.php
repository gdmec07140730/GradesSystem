...
<div class="am-cf admin-main">
	...
	<div class="am-cf am-padding">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">班级管理</strong> / <small>编辑</small></div>
	</div>
	<form class="am-form" action="<?php echo U('edit');?>" method="POST">
		<div class="am-g am-margin-top">
			...
			<div class="am-u-sm-8 am-u-md-4">
				<input type="hidden" class="am-input-sm" name="id" value="<?php echo $linkmess['id'] ;?>">
				<input type="text" class="am-input-sm" name="name" value="<?php echo $linkmess['name'] ;?>">
			</div>
