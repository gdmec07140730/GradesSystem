...
<div class="am-cf admin-main">
    ...
    <ul class="am-avg-sm-1 am-avg-md-3 am-margin am-padding am-text-center admin-content-list ">
      <li><a href="<?php echo U('Index/index') ;?>" class="am-text-success"><span class="am-icon-btn am-icon-home"></span><br/>系统首页<br/>　</a></li>
      <li><a href="<?php echo U('Term/index') ;?>" class="am-text-warning"><span class="am-icon-btn am-icon-users"></span><br/>学期管理<br/>　</a></li>
      <li><a href="<?php echo U('Class/index') ;?>" class="am-text-secondary"><span class="am-icon-btn am-icon-cog"></span><br/>班级设置<br/>　</a></li>
    </ul>

    <ul class="am-avg-sm-1 am-avg-md-3 am-margin am-padding am-text-center admin-content-list ">
      <li><a href="<?php echo U('Teacher/index') ;?>" class="am-text-danger"><span class="am-icon-btn am-icon-list"></span><br/>教师管理<br/>　</a></li>
      <li><a href="<?php echo U('Student/index') ;?>" class="am-text-danger"><span class="am-icon-btn am-icon-users"></span><br/>学生管理<br/>　</a></li>
