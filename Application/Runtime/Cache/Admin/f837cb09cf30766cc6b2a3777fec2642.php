...
<div class="am-cf admin-main">
	...
	<form class="am-form" action="<?php echo U('add');?>" method="POST" enctype="multipart/form-data" >
		<div class="am-g am-margin-top">
			<div class="am-u-sm-4 am-u-md-2 am-text-right">站点名称</div>
			<div class="am-u-sm-8 am-u-md-4">
				<input type="text" class="am-input-sm" name="sitename" value="<?php echo $site['sitename'] ;?>">
			</div>
			<div class="am-hide-sm-only am-u-md-6"></div>
		</div>

		<div class="am-g am-margin-top">
			<div class="am-u-sm-4 am-u-md-2 am-text-right">站点地址</div>
			<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
				<input type="text" class="am-input-sm" name="siteurl" value="<?php echo $site['siteurl'] ;?>">
			</div>
		</div>

		<div class="am-g am-margin-top">
			<div class="am-u-sm-4 am-u-md-2 am-text-right am-radio">站点图片</div>


			<div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
				<input type="text" class="am-input-sm" id="oldfile" name="siteimg" accept="image/jpeg,image/png,image/gif"  value="<?php echo $site['siteimg'] ;?>">
			</div>
		...
		<div class="am-g am-margin-top">
			...
			<div class="am-u-sm-8 am-u-md-4">
				<select data-am-selected="{btnSize: 'sm'}"	 name="status">
					<?php if($site['status'] == 1): ?><option value="1" selected="selected">启用</option>
