...
<div class="am-cf admin-main">
	...
	<div class="am-cf am-padding">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">代理商管理</strong> / <small>编辑</small></div>
	</div>
	<form class="am-form" action="<?php echo U('edit');?>" method="POST">
		<div class="am-g am-margin-top">
			<div class="am-u-sm-4 am-u-md-2 am-text-right">
				姓名
			</div>
			<div class="am-u-sm-8 am-u-md-4">
				<input type="hidden" class="am-input-sm" name="id" value="<?php echo $agentMess['id'] ;?>">
				<input type="text" class="am-input-sm" name="name" value="<?php echo $agentMess['name'] ;?>">
			</div>
		...
		<div class="am-g am-margin-top">
			...
			<div class="am-u-sm-8 am-u-md-4">
				<input type="text" class="am-input-sm" name="telephone" value="<?php echo $agentMess['telephone'] ;?>">
			</div>
			<div class="am-hide-sm-only am-u-md-6">　</div>
		</div>
		<div class="am-g am-margin-top">
			...
			<div class="am-u-sm-8 am-u-md-4">
				<input type="text" class="am-input-sm" name="qq" value="<?php echo $agentMess['qq'] ;?>">
			</div>
			<div class="am-hide-sm-only am-u-md-6">　</div>
		</div>
		<div class="am-g am-margin-top">
			...
			<div class="am-u-sm-8 am-u-md-4">
				<input type="text" class="am-input-sm" name="email" value="<?php echo $agentMess['email'] ;?>">
			</div>
			<div class="am-hide-sm-only am-u-md-6">　</div>
		</div>
		<div class="am-g am-margin-top">
			...
			<div class="am-u-sm-8 am-u-md-4">
				<input type="text" class="am-input-sm" name="city" value="<?php echo $agentMess['city'] ;?>">
			</div>
			<div class="am-hide-sm-only am-u-md-6">　</div>
		</div>
		<div class="am-g am-margin-top">
			...
			<div class="am-u-sm-8 am-u-md-4">
				<input type="text" class="am-input-sm" name="company" value="<?php echo $agentMess['company'] ;?>">
			</div>
			<div class="am-hide-sm-only am-u-md-6">　</div>
		</div>
		<div class="am-g am-margin-top">
			...
			<div class="am-u-sm-8 am-u-md-4">
				<input type="text" class="am-input-sm" name="url" value="<?php echo $agentMess['url'] ;?>">
			</div>
			<div class="am-hide-sm-only am-u-md-6">　</div>
		</div>
		<div class="am-g am-margin-top">
			...
			<div class="am-u-sm-8 am-u-md-4">
				<textarea class="" rows="5" id="user-intro"　name="introduct"><?php echo $agentMess['introduct'] ;?></textarea>
			</div>
			<div class="am-hide-sm-only am-u-md-6"></div>
		</div>
