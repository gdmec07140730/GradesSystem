...
<div class="am-cf admin-main">
			...
			<ul class="am-list admin-sidebar-list">
				...
				<li class="admin-parent">
					...
					<ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
						...
						<li>
							<a href="<?php echo U('Teacher/getlist');?>" class="am-cf">
	...
	<div class="am-cf am-padding">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">客户案例管理</strong> / <small>Case Manager</small></div>
	</div>
				...
				<table class="am-table am-table-striped am-table-hover table-main">
					...
					<tbody>
						<?php if(is_array($linklist)): $i = 0; $__LIST__ = $linklist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><a href="<?php echo $vo['siteurl'] ;?>"><?php echo $vo['siteurl'] ;?></a></td>
								<td><img src="/grades/Public/Upload/cast/<?php echo $vo['siteimg'] ;?>" style="height:60px" alt=""></td>
