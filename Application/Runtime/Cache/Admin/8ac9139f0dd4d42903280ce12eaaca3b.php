...
<div class="am-cf admin-main">
	...
	<div class="am-cf am-padding">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">用户管理</strong> / <small>管理</small></div>
	</div>
	...
	<div class="am-g">
		<div class="am-u-sm-12 am-u-md-12">
			<div class="am-btn-toolbar">
				...
				<div class="am-u-md-4">
					<form action="<?php echo U('index') ;?>" method="post">
						<div class="am-btn-group">
							...
							<button type="submit" class="am-btn am-btn-default">按班级查询</button>
						</div>
					</form>
				</div>
				...
				<form action="<?php echo U('index') ;?>" method="post">
					<div class="am-btn-group ">
						<input type="text" class="am-input" name="username" value="">
					</div>
					<div class="am-btn-group">
						<button type="submit" class="am-btn am-btn-default">按学号查询</button>
					</div>
				</form>
				...
				<table class="am-table am-table-striped am-table-hover table-main">
					...
					<tbody>
						<?php if(is_array($linklist)): $i = 0; $__LIST__ = $linklist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td class="am-hide-sm-only"><?php echo getClassName($vo['class_id']) ;?></td>
								<td>
									<div class="am-btn-toolbar">
										<div class="am-btn-group am-btn-group-xs">
